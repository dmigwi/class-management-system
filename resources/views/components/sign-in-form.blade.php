<div class="m-auto space-y-8 md:w-6/12 lg:w-4/12 xl:w-4/12 bg-gradient-to-tr">
    <div class="rounded-3xl border border-gray-100 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 backdrop-blur-2xl">
        ...
        <form action="" class="space-y-8">
            ...
            <div class="relative flex items-center justify-center">
                <button type="submit" class="btn overflow-hidden relative w-64 bg-blue-500 text-white py-4 px-4 rounded-xl font-bold uppercase -- before:block before:absolute before:h-full before:w-1/2 before:rounded-full before:bg-orange-400 before:top-0 before:left-1/4 before:transition-transform before:opacity-0 before:hover:opacity-100 hover:text-orange-200 hover:before:animate-ping transition-all duration-300">
