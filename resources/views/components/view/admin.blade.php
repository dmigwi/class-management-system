                ...
                <div class="relative w-full px-4 py-4 bg-white shadow-lg dark:bg-gray-700">
                    ...
                    <div class="mt-">
                        <span class="absolute p-4 bg-gray-200 rounded-full top-2 right-4">
                            <svg width="50" fill="currentColor" height="50"
                                class="absolute h-4 text-light-blue transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        ...
                        <div class="flex items-center justify-center space-x-12 text-sm md:space-x-24">
                            <div class="flex items-center text-xs">
                                ...
                                <button
                                    class="flex items-center justify-center mr-1 py-2 text-grays-500 border-1 btn-primary w-20"
                                    type="text">
