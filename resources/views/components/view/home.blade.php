    ...
    <div class="h-screen px-4 pb-24 overflow-auto my-6 md:px-6">
        <form class="flex items-center space-x-4">
            ...
            <button class="flex items-center pl-2 py-2 text-grays-500 border-2 rounded-lg text-sm btn-primary" type="text">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="border-black-500" height="15"
                    width="15" viewBox="0 0 520 520">
                    <path
            ...
            <div class="flex items-center w-full space-x-4 h-80 md:w-1/3">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg  h-full dark:bg-gray-700">
                    ...
                    @if ($role == "student")
                        <p>
                            ...
                            <span class="text-sm text-gray-400 dark:text-neutral-400">
                                {{$selectedCourse->lecturer ?? "Not Found"}}
                            </span>
                        </p>
                    @endif
                    <p>
                        ...
                        <span class="text-sm text-gray-400 dark:text-neutral-400">
                            {{$selectedCourse->unit ?? "Not Found"}}
                        </span>
                    </p>
                    <p>
                        <span class="text-start capitalize">Code:</span>
                        <span lass="text-sm text-gray-400 dark:text-neutral-400">
                            {{$selectedCourse->code ?? "Not Found"}}
                        </span>
                    </p>
                    <p>
                        <span class="text-start capitalize">Students:</span>
                        <span class="text-sm text-gray-400 dark:text-neutral-400">
                            {{$selectedCourse->students ?? "Not Found"}}
                        </span>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <span class="text-sm text-gray-400 dark:text-neutral-400">
                            {{$selectedCourse->start_date ?? "Not Found"}}
                        </span>
                    </p>
                    <p>
                        <span class="text-start capitalize">End Date:</span>
                        <span class="text-sm text-gray-400 dark:text-neutral-400">
                            {{$selectedCourse->end_date ?? "Not Found"}}
                        </span>
                    </p>
