          ...
          <div class="flex flex-wrap -mx-3 mb-2">
              <div class="w-full md:w-2/5 px-3 mb-6 md:mb-0">
                  ...
                  <input
                      ...
                      name="name" id="name" type="text" placeholder="Computational Mathematics" required>
              </div>
              <div class="w-fit px-3 mb-6 md:mb-0">
                  ...
                  <input
                      ...
                      id="code" name="code" type="text" placeholder="CME1234/2024">
              </div>
              <div class="w-fit px-3 mb-6 md:mb-0">
              ...
              <div class="w-fit px-3 mb-6 md:mb-0">
                  ...
                  <input id="year" name="year" type="text" placeholder="2023/2024" required
                      class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
              </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-2">
              <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input
                      class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      id="midterm_exam" name="midterm_exam" type="date" placeholder="7/01/2024">
              </div>
              <div class="w-full md:w-1/5 px-3 mb-6 md:mb-0">
                  <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="final_exam">
                      Final Exam Date
                  </label>
                  <input id="final_exam" type="date" placeholder="13/02/2024"
                      class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
              </div>
          </div>
