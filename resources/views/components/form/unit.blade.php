      ...
      <form class="w-fit max-w-lg">
              ...
              <div class="w-fit px-3 mb-8 md:mb-0">
                  ...
                  <div class="relative">
                      <select id="semester" name="semester"
                          ...
                          <option @checked($unit->semester ?? '' == "1") value="1">1</option>
                          <option @checked($unit->semester ?? '' == "2") value="2">2</option>
                          <option @checked($unit->semester ?? '' == "Summer") value="Summer">Summer</option>
                      </select>
                      <div
          ...
          <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full md:w-1/5 px-3 mb-8 md:mb-0">
                ...
                <input id="start_date" name="start_date" type="date" placeholder="7/01/2024" value="{{$unit->start_date ?? ''}}"
                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/>
            </div>
            <div class="w-full md:w-1/5 px-3 mb-8 md:mb-0">
                ...
                <input id="end_date" name="end_date" type="date" placeholder="13/02/2024" value="{{$unit->end_date ?? ''}}"
                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/>
            </div>
            <div class="w-full md:w-1/5 px-3 mb-8 md:mb-0">
                ...
                <input id="duration" name="duration" type="number" placeholder="12" value="{{$unit->duration ?? 0}}"
                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/>
                <p class="text-gray-600 text-xs italic mb-2">Classes Count</p>
            </div>
            <div class="w-full md:w-1/5 px-3 mb-8 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="midterm_exam">
                    Mid-Term Exam Date
                </label>
                <input id="midterm_exam" name="midterm_exam" type="date" placeholder="7/01/2024" value="{{$unit->midterm_exam ?? ''}}"
                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            </div>
            <div class="w-full md:w-1/5 px-3 mb-8 md:mb-0">
                ...
                <input id="final_exam" name="final_exam" type="date" placeholder="13/02/2024" value="{{$unit->final_exam ?? ''}}"
                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/>
            </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-2">
