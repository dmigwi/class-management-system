    ...
    <div class="flex items-start justify-between">
        <div class="relative hidden h-screen shadow-lg lg:block w-80">
            <div class="h-full bg-white dark:bg-gray-700">
                ...
                <nav class="mt-0">
                    <div>
                        <a class="flex items-center justify-start w-full p-3 my-2 text-gray-800 transition-colors duration-200 border-l-4 border-purple-500 dark:text-white" href="#">
                        ...
                        <a class="flex items-center justify-start w-full p-3 my-2 text-gray-400 transition-colors duration-200 border-l-4 border-transparent hover:text-gray-800" href="#">
                            <span class="text-left">
